...
#     precision = precision_score(yt, ypr, average='weighted')
#     recall = recall_score(yt, ypr, average='weighted')
#     f1score = f1_score(yt, ypr, average='weighted')
...
with open('results_MCMCGAN.pkl', 'wb') as f:
