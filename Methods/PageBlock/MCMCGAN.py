...
# Function to delete the discriminator model object
def delete_discriminator(discriminator):
    del discriminator
...
delete_discriminator(disc_GAN)
delete_generator(genGAN)
...
with open('PAGEBLOCK_MCMCGAN.pkl', 'wb') as f:
    pickle.dump((precision_MCMC_curve, recall_MCMC_curve, pr_auc_MCMC), f)

print("MCMCGAN Train - ",np.mean(train_accuracy_MCMC))
print("MCMCGAN Test - ",np.mean(test_accuracy_MCMC))
print("MCMCGAN F1-score - ",np.mean(f1_score_MCMC))
print("MCMCGAN precision - ",np.mean(precision_MCMC))
print("MCMCGAN recall - ",np.mean(recall_MCMC))


print("MCMCGAN Train - ",train_accuracy_MCMC)
print("MCMCGAN Test - ",test_accuracy_MCMC)
print("MCMCGAN F1-score - ",f1_score_MCMC)
print("MCMCGAN precision - ",precision_MCMC)
print("MCMCGAN recall - ",recall_MCMC)